...
async def file_read_write_demo():
...
if __name__ == "__main__":
    asyncio.run(file_listing_demo())
    asyncio.run(file_read_write_demo())
    asyncio.run(file_search_demo())
    asyncio.run(file_edit_demo())
