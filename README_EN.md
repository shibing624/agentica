...
Serves at `http://127.0.0.1:8881/chat` (chat, traces, settings). The first start creates an `admin` account and prints a random initial password in the terminal. For WeChat / WeCom / Feishu / Telegram, see the [Gateway docs](https://github.com/shibing624/agentica/blob/main/docs/advanced/gateway.md).
