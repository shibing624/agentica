...
EAGER_PUBLIC_EXPORTS = [
    ...
    "SkillCandidate", "GateVerdict", "SkillGateResult", "SkillAdmissionGate",
    "skill_fingerprint", "PROVENANCE_FILENAME", "get_provenance_path",
    "append_provenance_event", "read_provenance_events",
