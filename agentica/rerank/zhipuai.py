...
@description: ZhipuAI Reranker API adapter.
"""
...
class ZhipuAIRerank(Rerank):
    ...
    api_url: str = "https://open.bigmodel.cn/api/paas/v4/rerank"
    ...
    def rerank(self, query: str, documents: List[Document]) -> List[Document]:
        try:
            ...
            logger.error(f"Error reranking documents with ZhipuAI: {e}. Returning original documents")
            return documents
