...
class ToolConfig:
    ...
    # (that is the provider hard limit). Unset → Layer 2 new window at 95%
    # of the window. Set → Layer 2 at min(this, window×0.95); Layer 1
    # ratios use min(this, window) as the working window.
