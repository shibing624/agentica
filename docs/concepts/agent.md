...
**DeepAgent 内置工具**（`ls`, `read_file`, `write_file`, `edit_file`, `multi_edit_file`, `apply_patch`, `glob`, `grep`, `execute`, `web_search`, `fetch_url`, `write_todos`, `task`, `ask_user_question`, `save_memory`, `search_memory`）
